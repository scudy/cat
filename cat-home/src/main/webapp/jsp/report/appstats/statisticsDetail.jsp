  ...
  <div class="tab-pane" id="tabContent-all">
	<table class="table table-striped table-condensed table-hover table-bordered" id="contents-all" style="width:100%">
		...
		<tr>
			...
			<th><a href="/cat/r/appstats?domain=${model.domain}&day=${payload.day}&sort=request">平均发包(B)</th>
			<th><a href="/cat/r/appstats?domain=${model.domain}&day=${payload.day}&sort=response">平均回包(B)</th>
		</tr>
		</thead>
		<tbody>
